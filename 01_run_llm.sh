...
# python3 01_run_llm.py --model_name=llama3:8b --prompting_method=IP --reports_to_process=-1 >> log-files/llama3:8b_temp0.txt
# python3 01_run_llm.py --model_name=llama3:8b --prompting_method=CoT --reports_to_process=-1 >> log-files/llama3:8b_CoT_temp0.txt
